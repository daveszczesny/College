...
public class Account implements Serializable {
	...
	// Define serialVersionUID which is used during object deserialization to verify
	// that the sender and receiver of a serialized
	// object have loaded classes for that object that are compatible - will throw
	// InvalidClassException if not compatible
	...
	private void writeObject(ObjectOutputStream aOutputStream) throws IOException {
		...
		// We don't write value for the LocalDateTime activated variable as we will
		// reinitialise this when reloading the object
	}
